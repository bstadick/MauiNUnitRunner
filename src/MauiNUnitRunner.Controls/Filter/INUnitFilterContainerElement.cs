...
public interface INUnitFilterContainerElement
{
    ...
    ///     <paramref name="testIds" /> is <c>null</c> or empty or only contains <c>null</c> and
    ///     empty strings.
    /// </exception>
    ...
    /// <exception cref="ArgumentException"><paramref name="testName" /> is <c>null</c> or empty.</exception>
    /// <exception cref="InvalidOperationException">The <see cref="INUnitFilterBaseElement.Child" /> has already been set.</exception>
    ...
    /// <exception cref="ArgumentException"><paramref name="testCategory" /> is <c>null</c> or empty.</exception>
    /// <exception cref="InvalidOperationException">The <see cref="INUnitFilterBaseElement.Child" /> has already been set.</exception>
    ...
    /// <exception cref="ArgumentException"><paramref name="className" /> is <c>null</c> or empty.</exception>
    /// <exception cref="InvalidOperationException">The <see cref="INUnitFilterBaseElement.Child" /> has already been set.</exception>
    ...
    /// <exception cref="ArgumentException"><paramref name="methodName" /> is <c>null</c> or empty.</exception>
    /// <exception cref="InvalidOperationException">The <see cref="INUnitFilterBaseElement.Child" /> has already been set.</exception>
    ...
    /// <exception cref="ArgumentException"><paramref name="namespaceName" /> is <c>null</c> or empty.</exception>
    /// <exception cref="InvalidOperationException">The <see cref="INUnitFilterBaseElement.Child" /> has already been set.</exception>
    ...
    /// <exception cref="ArgumentException">
    ///     <paramref name="propertyName" /> or <paramref name="propertyValue" /> is <c>null</c> or
    ///     empty.
    /// </exception>
    /// <exception cref="InvalidOperationException">The <see cref="INUnitFilterBaseElement.Child" /> has already been set.</exception>
    ...
    /// <exception cref="ArgumentException"><paramref name="nunitTestName" /> is <c>null</c> or empty.</exception>
    /// <exception cref="InvalidOperationException">The <see cref="INUnitFilterBaseElement.Child" /> has already been set.</exception>
