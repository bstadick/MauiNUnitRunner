...
internal class NUnitFilterContainerElement : INUnitFilterContainerElementInternal
{
    ...
    ///     <paramref name="parent" /> is <c>null</c> and <paramref name="elementType" /> is not
    ///     <see cref="NUnitElementType.RootFilter" />.
    /// </exception>
    /// <exception cref="ArgumentException">
    ///     <paramref name="parent" /> is not <c>null</c> and <paramref name="elementType" /> is
    ///     <see cref="NUnitElementType.RootFilter" />.
    /// </exception>
    /// <exception cref="ArgumentOutOfRangeException"><paramref name="elementType" /> is not supported by this class.</exception>
    public NUnitFilterContainerElement(INUnitFilterBaseElement parent, NUnitElementType elementType)
    {
        ...
        if (parent != null && elementType == NUnitElementType.RootFilter)
        {
            throw ExceptionHelper.ThrowArgumentException(ResourceHelper.GetResourceString("ArgumentExceptionForRootFilterElementNullMessage"),
                nameof(parent));
        }
