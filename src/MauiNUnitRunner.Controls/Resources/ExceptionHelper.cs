...
internal static class ExceptionHelper
{
    ...
    {
        return new ArgumentNullException(paramName, Format(ResourceHelper.GetResourceString("ArgumentNullExceptionMessage"), paramName));
    }
    ...
    {
        return new ArgumentException(Format(ResourceHelper.GetResourceString("ArgumentExceptionMessageForNullOrEmptyMessage"), paramName),
            paramName);
    }
        ...
        object actualValue, string arg = "")
    {
        ...
        return new ArgumentOutOfRangeException(paramName, actualValue, Format(
            ResourceHelper.GetResourceString("ArgumentOutOfRangeExceptionElementTypeEnumMessage"), arg));
    }
        ...
        object actualValue)
    {
        return new ArgumentOutOfRangeException(paramName, actualValue,
            Format(ResourceHelper.GetResourceString("ArgumentOutOfRangeExceptionForLessThanZeroMessage"), paramName));
    }
    ...
    {
        return new InvalidOperationException(ResourceHelper.GetResourceString("InvalidOperationExceptionChildAlreadySetMessage"));
    }
        ...
        string parent)
    {
        return new InvalidOperationException(Format(msg, parent) + " " +
                                             ResourceHelper.GetResourceString("InvalidOperationExceptionFilterBuildMessage"));
    }
